---
sidebar_position: 4
title: Develop locally with the developer mode of Primno
description: Run the developer mode and see immediately your changes in the browser without having to publish your changes to Power Apps.
...
Now that you have seen how to start a project, you can learn more in the [guides](../guides/index.mdx) section.